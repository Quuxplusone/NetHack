...
int part;
{
	...
	*jelly_parts[] = { "pseudopod", "dark spot", "front",
		...
		"surface", "sensor", "stomach", "underside"},
	...
	*horse_parts[] = { "foreleg", "eye", "face", "forehoof", "hoof tip",
		...
		"mane", "blood", "lung", "nose", "stomach", "rump"},
	*sphere_parts[] = { "appendage", "optic nerve", "body", "tentacle",
		...
		"olfactory nerve", "interior", "underside"},
	*fungus_parts[] = { "mycelium", "visual area", "front", "hypha",
		...
		"spores", "juices", "gill", "gill", "interior", "underside"},
	*vortex_parts[] = { "region", "eye", "front", "minor current",
		...
		"center", "leading edge", "interior", "base"},
	*snake_parts[] = { "vestigial limb", "eye", "face", "large scale",
		"large scale tip", "rear region", "scale gap", "scale gapped",
		"head", "rear region", "light headed", "neck", "length",
		"rear scale", "scales", "blood", "lung", "forked tongue",
		"stomach", "underside"},
	*fish_parts[] = { "fin", "eye", "premaxillary", "pelvic axillary",
		"pelvic fin", "anal fin", "pectoral fin", "finned", "head",
		"peduncle", "played out", "gills", "dorsal fin", "caudal fin",
		"scales", "blood", "gill", "nostril", "stomach", "underside"};
